...
return [
    ...
    'auth' => [
        'enabled' => true,        // ativa auth
        'default' => true,        // define auth como padrão para todos os endpoints
        'in' => \Knuckles\Scribe\Config\AuthIn::BEARER->value,
        'name' => 'Authorization',
        'use_value' => env('SCRIBE_AUTH_KEY', 'Bearer <SEU_JWT_DE_TESTE>'),
        'placeholder' => '{YOUR_JWT_TOKEN}',
        'extra_info' => 'Use um token JWT válido obtido via /api/session',
    ],
